...
(defconst complementary-light-package-face-rules
  '(
    ...
    (magit-bisect-good :package magit :foreground foreground)
    ...
    (magit-process-ok :package magit :foreground foreground)
    ...
    (magit-signature-good :package magit :foreground foreground)
    ...
    (vundo-saved :package vundo :foreground foreground)
    ...
    (wgrep-done-face :package wgrep :foreground foreground))
